...
const CustomThemeTile = function({ customThemeData = false } = {}) {
  ...
  this.element = {
    ...
    custom: new Button({
      ...
      func: () => {
        ...
        const newPresetData = JSON.parse(JSON.stringify(customThemeData));

        state.get.current().theme.color.range.primary.h = newPresetData.theme.color.range.primary.h;

        state.get.current().theme.color.range.primary.s = newPresetData.theme.color.range.primary.s;

        state.get.current().theme.color.contrast = newPresetData.theme.color.contrast;

        state.get.current().theme.accent.hsl = newPresetData.theme.accent.hsl;

        state.get.current().theme.accent.rgb = newPresetData.theme.accent.rgb;

        state.get.current().theme.font = newPresetData.theme.font;

        state.get.current().theme.background = newPresetData.theme.background;

        state.get.current().theme.radius = newPresetData.theme.radius;

        state.get.current().theme.shadow = newPresetData.theme.shadow;

        state.get.current().theme.style = newPresetData.theme.style;

        state.get.current().theme.shade = newPresetData.theme.shade;
